...
## 👨‍🎓 Apresentacao: 
- <a href="https://youtu.be/sXgy_Gmon5o">Video Apresentação - YOUTUBE</a>
...
Um totem – também conhecido como sistema de ponto de venda (PDV) de autoatendimento – é um dispositivo interativo com tela sensível ao toque que permite aos clientes comprar produtos ou serviços sem a assistência de funcionários. Inclui componentes de hardware e software que permitem aos clientes navegar pelos itens, fazer pedidos, validar documentação, pequisa e por fim realizar processos de pagamentos forma independente. 
